...
Concretely we can imagine a scheme where all content that is smaller than the size of the hash is inlined. Based on observations this would be about 80% of the content in the Tezos Context Store. We can expect considerable optimization in disk usage and hopefully also overall performance.
