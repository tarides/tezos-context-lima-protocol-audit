...
| [[#path-cache][Path Cache]]                          | -                                                 | Medium    |
| [[#inline][Inline small objects]]                | -                                                 | High      |
| [[#cpu-boundness][General CPU efficiency improvments]]  | -                                                 | High      |
| [[#compactness][More compact on-disk representation]] | -                                                 | High      |
| [[#tezos-storage-functors][Optimize Tezos Storage Functors]]     | -                                                 | High      |
| [[#multicore][Multicore]]                           | 700%                                              | Very High |
