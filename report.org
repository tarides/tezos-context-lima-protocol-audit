...
** TODO Inline small objects
:PROPERTIES:
:CUSTOM_ID: inline
:END:

https://github.com/mirage/irmin/issues/884

** TODO Optimize tree descent
*** TODO Flatten Path

- Use Irmin as a key-value store

*** TODO Path Cache

Maintain a cache from ~path -> node~
...
Read performance seems to be bad because of the small size of individual reads that incur a very high system call overhead.
...
| Description                         | Potential improvement [fn:: On raw I/O bandwidth] | Effort    |
|-------------------------------------+---------------------------------------------------+-----------|
| [[#disable-os-page-cache][Disable OS page cache]]               | 30%                                               | Low       |
| [[#multicore][Multicore]]                           | 700%                                              | High      |
| [[#cpu-boundness][General CPU efficiency improvments]]  | unknown                                           | Medium    |
| [[#compactness][More compact on-disk representation]] | unknown                                           | High      |
| [[#inline][Inline small objects]]                | unknown                                           | High      |
| [[#tezos-storage-functors][Optimize Tezos Storage Functors]]     | unknown                                           | High      |
| [[#async-io][Asynchronous I/O]]                    | 40000%                                            | Very high |
