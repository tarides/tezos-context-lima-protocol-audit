...
- I/O :: Potential improvement in I/O performance.
- Overall :: Potential improvement in overall performance of the Tezos Context store.
- Effort :: Estimated effort to implement performance.
- On-disk format :: Does the on-disk format change.
