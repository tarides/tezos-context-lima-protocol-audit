...
| [[#disable-os-page-cache][Disable OS page cache]]               |     0% | 30%                                                     | Low       | No change        |
| [[#inline][Inline small objects]]                |  19.5% | 3.5%                                                    | High      | Change           |
| [[#path-cache][Path Cache]]                          |      - | n/a [fn::hard to estimate]                              | Medium    | No change        |
| [[#cpu-boundness][General CPU efficiency improvements]] |      - | n/a [fn::could be important, but difficult to identify] | High      | Potential change |
| [[#compactness][More compact on-disk representation]] |   300% | n/a [fn::could be negative]                             | High      | Change           |
| [[#tezos-storage-functors][Optimize Tezos Storage Functors]]     |      - |                                                         | High      | No change        |
| [[#batching-reads][Batching reads]]                      |    60% | up to 4%?                                               | Very high | Change           |
| [[#multicore][Multicore]]                           |   700% | up to 8%?                                               | Very high | No change        |
| [[#async-io][Asynchronous I/O]]                    | 40000% | up to 10%?                                              | Epic      | Change           |
