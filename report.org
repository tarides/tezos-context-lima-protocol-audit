...
| [[#path-cache][Path Cache]]                          |      - | hard to estimate                              | Medium    | No change        |
| [[#cpu-boundness][General CPU efficiency improvements]] |      - | could be important, but difficult to identify | High      | Potential change |
| [[#compactness][More compact on-disk representation]] |   300% | could be negative                             | High      | Change           |
